...
export class CategoriasSocioController {
    constructor() {
        this.createCategoriaSocio = asyncHandler(async (req, res) => {
            try {
                const { categoria, limiteDeJugadores } = req.body;
                const { actividadid } = req.params;
                const { club_asociado } = req.user;
                await this.categoriasSocioApi.createCategoriaSocio(categoria, club_asociado.id, actividadid, limiteDeJugadores);
        ...
        this.getCategoriasActividad = asyncHandler(async (req, res) => {
            try {
        ...
        this.getAllSociosEnCategoria = asyncHandler(async (req, res) => {
            try {
        ...
        this.getAllCategorias = asyncHandler(async (req, res) => {
            try {
