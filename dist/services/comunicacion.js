...
export class ComunicacionApi {
    ...
    async enviarMailsMasivos(message, subject, actividadId, tipoSocioId, clubAsociadoId) {
        const targetSocios = await this.sociosApi.getAllSociosWithEmailInActividadOrTipoSocio(actividadId, tipoSocioId, clubAsociadoId);
        let from = process.env.EMAIL_USER;
