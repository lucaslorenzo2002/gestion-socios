import mercadopago, { MercadoPagoConfig, PreApproval, Preference, Payment, CustomerCard, Customer } from 'mercadopago';
import { IInfoCuota } from '../interfaces/IInfoCuotas.js';
import { BadRequestError } from '../errors/bad-request-error.js';

export const createOrder = async(infoCuotas: IInfoCuota[]) => {
...
export const findOrder = async(dataId: number) => {
	const client = new MercadoPagoConfig({
		accessToken: 'TEST-3865151540386071-120307-1f85192c46613971d7c6c18f8a1171a5-1574396113'
	})
...
export const createSubscription = async(socioEmail: string, startDate: string, transactionAmount: number) => {
...
export const createClient = async(socioEmail: string) => {
	const client = new MercadoPagoConfig({
		accessToken: 'TEST-3865151540386071-120307-1f85192c46613971d7c6c18f8a1171a5-1574396113'
	})
