...
export class ActividadesDAO{
	...
	async crearSocioActividad(socioActividad, actividadId: number){
		try {
	...
	async getAllSociosEnActividad(actividadId: number, clubAsociado: number){
		try {
	...
	async getAllSociosSinActividad(actividadId: number, clubAsociado: number){
		try {
	...
	async cuotaInscripcionPendiente(socioId: number, actividadId: number, clubAsociadoId: number){
		try {
	...
	async cuotaInscripcionPaga(socioId: number, actividadId: number, clubAsociadoId: number){
		try {
